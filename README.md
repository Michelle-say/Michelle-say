...
- Passionate about data analysis, and like to manipulate it and make it visual so that everyone can see its strengths. Flexible, I can handle data scientist tasks (ML, Computer vision, NLP), but also tasks dedicated to data engineers (modelling, pipeline).

- I'm looking forward to taking on new tasks and continuing to develop my skills. I'm planning to take part in not-for-profit projects, to help young people from disadvantaged areas to discover data, and also to take part in projects for the common good.
